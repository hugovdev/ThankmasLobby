...
public class FlyOption implements Option {
    ...
    public FlyOption() {
        ...
        this.states.add(new OptionState(1, Material.FEATHER, NamedTextColor.GREEN, Material.GREEN_STAINED_GLASS_PANE, "ON", this));
    }
    ...
    public List<Component> getDescription(OptionState state, boolean isGlassPane) {
        return Arrays.asList(Component.text("Enable or disable your ability to fly!", NamedTextColor.GRAY), Component.text(""),
                isGlassPane ? Component.text(state.getStateName(), state.getStateColor()) : Component.text("Click to change!", NamedTextColor.YELLOW));
    }
